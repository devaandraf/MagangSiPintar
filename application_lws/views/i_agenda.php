    ...
    <body>
        ...
        <div class="service_area minus_padding">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <form class="form-area contact-form text-right" action="<?= base_url() ?>index.php/I_agenda/inputAgenda" method="post" enctype="multipart/form-data">
                            <div class="row">
...
<!--                                    <select class="common-input mb-20 form-control" name="penyelenggara" required>
                                        <option value="" class="l1" selected>Pilih Penyelenggara ..</option>
                                        <?php foreach ($nama_pl as $key => $value) { ?>
                                            <option class="l2" value="<?= $value->nama ?>"><?= $value->nama ?></option>
                                        <?php } ?>
                                    </select>-->
                                ...
                                <div class="col-lg-6 form-group">
                                    <input name="nm_kota" placeholder="Nama Kota" class="common-input mb-20 form-control" required="" type="text">
                                    ...
                                    <select class="common-input mb-20 form-control" name="eo" required>
                                        <option value="" class="l1" selected>Pilih Event Organizer ..</option>
                        ...
                        <div class="au-card m-b-30">
                            <div class="au-card-inner">
                                <table id="kinerja" class="table table-hover responsive nowrap" style="width:100%">
                                    <h2 style="text-align:center">DATA AGENDA PAMERAN YANG <b style="color:red">AKAN DILAKSANAKAN</b></h2>
                                    <thead>
                                    ...
                                    <tbody>
                                        <?php $i = 1;
                                        foreach ($agendanull as $key => $value) { ?>
                                            <tr>
                                                <td><?= $i++ ?></td>
                                                ...
                                                <!--<td><?= $value->nilai ?></td>-->
                                                <td>
                                                    <button class="btn btn-success btn-sm"><a style="color:white" href="<?= base_url() ?>index.php/I_agenda/addUmkm/<?= $value->id ?>">TAMBAH UMKM</a></button>
                                                    <button class="btn btn-warning btn-sm"><a href="<?= base_url() ?>index.php/I_agenda/edit/<?= $value->id ?>">EDIT</a></button>
                    ...
                    <div class="col-lg-12" style="padding-top: 50px">
                        <div class="au-card m-b-30">
                            <div class="au-card-inner">
                                <table id="kinerjasdh" class="table table-hover responsive nowrap" style="width:100%">
                                    <h2 style="text-align:center">DATA AGENDA PAMERAN YANG <b style="color:green">SUDAH DILAKSANAKAN</b></h2>
                                    <thead>
                                        <tr style="background: #c3c3c3;">
                                            <th>No</th>
                                            <th>Agenda</th>
                                    ...
                                    <tbody>
                                        <?php $i = 1;
                                        foreach ($agendanullsdh as $key => $value) { ?>
                                            <tr>
                                                <td><?= $i++ ?></td>
                                                <td><?= $value->nama_agenda ?></td>
                                                <td><?= $value->tgl_mulai ?></td>
        ...
        <div class="modal fade" id="deletemodal" tabindex="-1" role="dialog" aria-labelledby="largemodalLabel" aria-hidden="true">
            <form method="POST" action="<?= base_url() ?>index.php/I_agenda/deleteAgendaDN">
                <div class="modal-dialog modal-sm" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer" style="text-align: center;">
                            ...
                            <button class="btn btn-danger btn-sm">Delete Agenda</button>
                        </div>
                    </div>
                </div>
            </form>
...
<?php $this->load->view('template/js') ?>
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                $('#kinerjasdh').DataTable({dom: 'Bfrtip',
                    responsive: true,
                    buttons: [
                        {extend: 'excel', className: 'btn btn-success btn-sm'},
                        {extend: 'pdf', className: 'btn btn-danger btn-sm'}
