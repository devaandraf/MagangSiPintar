        ...
        <div class="service_area minus_padding">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <form class="form-area contact-form text-right" action="<?= base_url() ?>index.php/E_penyelenggara/inputData" method="post" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-lg-6 form-group">
                                     <input name="nm_pl" placeholder="NAMA PENYELENGGARA" autocomplete="off"  class="common-input mb-20 form-control" required="" type="text">
                                </div>
                                <div class="col-lg-6 form-group">
                                    <input name="almt_pl" placeholder="ALAMAT PENYELENGGARA"   autocomplete="off"  class="common-input mb-20 form-control" required="" type="text">
                                </div>
                                <div class="col-lg-6 form-group">
                                    <input name="cp_pl" placeholder="CONTACT PERSON PENYELENGGARA"   autocomplete="off"  class="common-input mb-20 form-control" required="" type="text">
                                </div>
                                <div class="col-lg-6 form-group">
                                    <input name="no_pl" placeholder="NOMOR TELPHONE PENYELENGGARA"   autocomplete="off"  class="common-input mb-20 form-control" required="" type="text">
                                </div>
                                <div class="col-lg-12">
                        ...
                        <div class="au-card m-b-30">
                            <div class="au-card-inner">
                                <table id="kinerja" class="table table-hover responsive nowrap" style="width:100%">
                                    <h2 style="text-align:center">DATA PENYELENGGARA</h2>
                                    <thead>
                                    ...
                                    <tbody>
                                        <?php $i=1; foreach ($pl as $key => $value){?>
                                        <tr>
                                            <td><?=$i++?></td>
                                            <td><?= $value->nama ?></td>
                                            <td><?= $value->alamat ?></td>
                                            ...
                                            <td style="text-align:center">
                                                    <button class="btn btn-warning btn-sm"><a href="<?= base_url()?>index.php/E_penyelenggara/edit/<?=$value->id?>">EDIT</a></button>

                                                    <button class="btn btn-danger btn-sm" data-target="#deletemodal" data-toggle="modal" data-id="<?= $value->id ?>">DELETE PENYELENGGARA</button>
                                            </td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>
