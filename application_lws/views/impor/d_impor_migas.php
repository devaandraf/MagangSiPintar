                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="bradcam_text text-center">
                                <h3>Inputan Data Impor Migas</h3>
        ...
        <div class="service_area minus_padding">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <form class="form-area contact-form text-right" action="<?= base_url() ?>index.php/Data_impor_migas/inputSektor" method="post">
                            <div class="row">
                                <div class="col-lg-6 form-group">
                                    <input type="hidden" name="migas" value="MIGAS">
                                     <input name="bulan_sektor" placeholder="BULAN NON MIGAS" id="txtTahun1" autocomplete="off"  class="common-input mb-20 form-control" required="" type="text">
                                </div>
                                <div class="col-lg-6 form-group">
                        ...
                        <div class="au-card m-b-30">
                            <div class="au-card-inner">
                                <table id="kinerja" class="table table-hover responsive nowrap" style="width:100%">
                                    <h2 style="text-align:center">DATA IMPOR MIGAS</h2>
                                    <thead>
                                    ...
                                    <tbody>
                                        <?php $i=1; foreach ($imp_migas as $key => $value){?>
                                        <tr>
                                            <td><?=$i++?></td>
