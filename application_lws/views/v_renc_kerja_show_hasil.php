                        ...
                        <div class="au-card m-b-30">
                            <div class="au-card-inner">
                                <table id="kinerja" class="table table-hover responsive nowrap" style="width:100%">
                                    <h2 style="text-align:center">HASIL RENCANA KERJA</h2>
                                    <thead>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?= $value->tgl_agenda ?></td>
                                            <td><?= $value->keterangan ?></td>
                                            <td><?php if($value->filefoto==NULL||$value->filefoto==''){?>
                                                    <?php }else{?>
                                                      <button class="btn btn-success"> 
                                                          <a style="color:white" target="_blank" href="<?= base_url()?>assets/file_renc_kerja/<?=$value->filefoto?>">Download </a>
                                                      </button>
                                                    <?php }?>
                                            <td><?php if($value->filelaporan==NULL||$value->filelaporan==''){?>
                                                    <?php }else{?>
                                                      <button class="btn btn-success"> 
                                                          <a style="color:white" target="_blank" href="<?= base_url()?>assets/file_renc_kerja/<?=$value->filelaporan?>">Download </a>
                                                      </button>
                                                    <?php }?>
                                            </td>
