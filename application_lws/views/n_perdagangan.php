                ...
                <div class="card-body card-block" >
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="au-card m-b-30" >
                                <div class="au-card-inner">
                                    <h3 class="title-2 m-b-40" style="text-align:center">NERACA DAGANG <br><b>PUSDATIN</b> <br>TAHUN <?= $neracamonth->tahun?> <br><?= date('F', strtotime("early month"));?> - <?=$neracamonth->bln_akhir?></h3>
                                    <div id="chartdiv"></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12">
                            <div class="au-card m-b-30" >
                                <div class="au-card-inner"> 
                                    <h3 class="title-2 m-b-40" style="text-align:center">10 NEGARA TUJUAN EKSPOR TAHUN <?= $neracamonth->tahun?> <br><?= date('F', strtotime("early month"));?> - <?=$neracamonth->bln_akhir?></h3>
                                    <h6  class="title-2 m-b-40" style="color:#f95e13;text-align:center">Data Pusdatin</h6>
                        ...
                        <div class="col-lg-12">
                            <div class="au-card m-b-30" >
                                <div class="au-card-inner"> 
                                    <h3 class="title-2 m-b-40" style="text-align:center">10 NEGARA ASAL IMPOR TAHUN <?= $neracamonth->tahun?> <br><?= date('F', strtotime("early month"));?> - <?=$neracamonth->bln_akhir?></h3>
                                     <h6  class="title-2 m-b-40" style="color:#f95e13;text-align:center">Data Pusdatin</h6>
                        ...
                        <div class="col-lg-12">
                            <div class="au-card m-b-30" >
                                <div class="au-card-inner"> 
                                    <h3 class="title-2 m-b-40" style="text-align:center">10 KOMODITI EKSPOR TAHUN <?= $neracamonth->tahun?> <br><?= date('F', strtotime("early month"));?> - <?=$neracamonth->bln_akhir?></h3>
                                     <h6  class="title-2 m-b-40" style="color:#f95e13;text-align:center">Data Pusdatin</h6>
                        ...
                        <div class="col-lg-12">
                            <div class="au-card m-b-30" >
                                <div class="au-card-inner"> 
                                    <h3 class="title-2 m-b-40" style="text-align:center">10 KOMODITI IMPOR TAHUN <?= $neracamonth->tahun?> <br><?= date('F', strtotime("early month"));?> - <?=$neracamonth->bln_akhir?></h3>
                                     <h6  class="title-2 m-b-40" style="color:#f95e13;text-align:center">Data Pusdatin</h6>
