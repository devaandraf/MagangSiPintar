       ...
       <?php
            ...
            <div class="container">				
                <div class="row d-flex align-items-center justify-content-center">
                    <div class="about-content col-lg-12">
                        <h1 class="text-white">
                            Kinerja Eskpor Jawa Timur Jan-Des				
                        </h1>	
                    ...
                    <table style="width:100%;">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <input name="ttl_d" class="common-input mb-20 form-control" required="" type="text" disabled="">
                                </td>
                                <td>
                                    <input name="ttl_persen" class="common-input mb-20 form-control"  required="" type="text" disabled="">
                                </td>
                            </tr>
                            <tr>
                                <td><p>2</p></td>
        ...
        <script type="text/javascript">
            function calc() {
                  ...
                  //D PERSEN
                  t_migas = nil4 - nil3;
                  d_migas = t_migas/nil3;
                  d_persen = d_migas * 100;
                  
                  t_nonmigas = nil14 - nil13;
                  d_nonmigas = t_nonmigas/nil13;
                  d_persen2  = d_nonmigas*100;
