...
//        PROV JATIM AKA PEPI
        ...
        $sql = "
                ...
                'EKSPOR' as kategori
                FROM 
                (SELECT NILAI_USD as nilai FROM V_PEPI_EKSPOR WHERE TAHUN='$datenow') D 
                ...
                'IMPOR' as kategori
                FROM 
                (SELECT NILAI_USD as nilai FROM V_PEPI_IMPOR WHERE TAHUN='$datenow') D 
...
//            die();
        ...
        $sql = "SELECT NILAI_USD as nilai FROM V_PEPI_EKSPOR WHERE TAHUN='$datenow'";
//            print($sql);
//            die();
            $result = $this->db->query($sql);
            return $result->row();
        ...
        $sql = "SELECT NILAI_USD as nilaiI FROM V_PEPI_IMPOR WHERE TAHUN='$datenow'";
//            print($sql);
//            die();
            $result = $this->db->query($sql);
            return $result->row();
        ...
        public function getNegEksporSKA($datenow){
            $sql = "SELECT a.negara_urai as negara, format(SUM(b.fobUsd),2) as nilai
                    ...
                    INNER JOIN ska_mulf_ceptdtl b on a.id = b.header_id
