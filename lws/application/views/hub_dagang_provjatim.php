                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="bradcam_text text-center">
                            <h3>Hubungan Dagang Data PROV. JATIM</h3>
        ...
        <div class="service_area minus_padding">
                    ...
                    <div class="col-lg-12">
                        <div class="au-card m-b-30">
                            <div class="au-card-inner">
                                ...
                                <label style="color:red">* Periode Tahun <?= $month->tahun?> <?= date('F', strtotime("early month"));?> - <?=$month->bln_akhir?></label>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-12">
                        <div class="au-card m-b-30">
                            <div class="au-card-inner">
                                ...
                                <label style="color:red">* Periode Tahun <?= $monthI->tahun?> <?= date('F', strtotime("early month"));?> - <?=$monthI->bln_akhir?></label>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <?php if (!isset($this->session->userdata['user_role']) || $this->session->userdata['user_role'] == "") { ?>
                <div class="col-lg-12" style="padding-top: 50px">
                    <div class="au-card m-b-30">
                        <div class="au-card-inner">
                            <table id="analisa" class="table table-hover responsive nowrap" style="width:100%">
...
<?php } elseif ($this->session->userdata['user_role'] == "ADMIN") { ?>
                <div class="container">
                    ...
                    <div class="row py-5">
                        <div class="col-lg-12">
                            <form  action="<?= base_url() ?>index.php/show/Hub_dagang_provjatim/analisa" method="post">
                                <div class="row">	
...
<?php } ?>
          ...
          <div class="modal fade" id="deletemodal" tabindex="-1" role="dialog" aria-labelledby="printmodalLabel" aria-hidden="true">
            <form method="POST" action="<?= base_url() ?>index.php/show/Hub_dagang_provjatim/del_analisa">
        ...
        <div class="modal fade" id="editmodal" tabindex="-1" role="dialog" aria-labelledby="editmodalLabel" aria-hidden="true">
            <form method="POST" action="<?= base_url() ?>index.php/show/Hub_dagang_provjatim/editAnalisa" enctype="multipart/form-data">
        ...
        <script type="text/javascript">
                                        ...
                                        $(function () {
                                            $('#btnTampilkan').click(function () {
                                                ...
                                                $.ajax({
                                                    type: "POST",
                                                    url: "<?php echo base_url(); ?>index.php/show/Hub_dagang_provjatim/getNegaraPepi",
                                                    data: {
                                                        "negara": negara
                                                    },
                                                    dataType: "html",
                                                ...
                                                $.ajax({
                                                    type: "POST",
                                                    url: "<?php echo base_url(); ?>index.php/show/Hub_dagang_provjatim/getNerEksporPepi",
                                                    data: {
                                                        "negara": negara
                                                    },
                                                    dataType: "html",
                                                ...
                                                $.ajax({
                                                    type: "POST",
                                                    url: "<?php echo base_url(); ?>index.php/show/Hub_dagang_provjatim/getNerImporPepi",
                                                    data: {
                                                        "negara": negara
                                                    },
                                                    dataType: "html",
                                                ...
                                                $.ajax({
                                                    type: "POST",
                                                    url: "<?php echo base_url(); ?>index.php/show/Hub_dagang_provjatim/getHubKomoEkspor",
                                                    data: {
                                                        "negara": negara
                                                    },
                                                    dataType: "html",
                                                ...
                                                $.ajax({
                                                    type: "POST",
                                                    url: "<?php echo base_url(); ?>index.php/show/Hub_dagang_provjatim/getHubKomoImpor",
                                                    data: {
                                                        "negara": negara
                                                    },
                                                    dataType: "html",
 ...
 $('#deletemodal').on('shown.bs.modal', function (e) {
            ...
            $('#editmodal').on('shown.bs.modal', function (e) {
             ...
             $('#editmodal').on('shown.bs.modal', function (e) {
                        var id = $(e.relatedTarget).data('id');
                        $.ajax({
                            url: '<?= base_url() ?>index.php/show/Hub_dagang_provjatim/ajax_get_data/' + id,
                            dataType: 'json',
