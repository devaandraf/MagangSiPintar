                    ...
                    <table style="width:100%;">
                        <thead>
                            <tr>
                                ...
                                <th>
                                    <input type="text" style="margin:0px" class="common-input mb-20 form-control"  placeholder="Tahun " data-mask id="txtTahun4" autocomplete="off">
                                </th>
