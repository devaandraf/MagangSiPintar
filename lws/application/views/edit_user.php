            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        ...
                        <form class="form-area contact-form text-right" action="<?= base_url() ?>index.php/User/updateUser" method="post">
                            <div class="row">
                                <div class="col-lg-6 form-group">
                                    <!--<label>Nama </label>-->
                                    <input type="hidden" value="<?=$edit_user->id?>" name="id">
                                    <input name="nm_user" value="<?=$edit_user->user_login?>" placeholder="Nama User"  class="common-input mb-20 form-control" required="" type="text" autocomplete="off">

                                    <input name="pass"  placeholder="Password"  class="common-input mb-20 form-control" required="" type="password" autocomplete="off">
                                </div>
                                <div class="col-lg-6 form-group">
                                    <input name="email" value="<?=$edit_user->user_email?>" placeholder="Email" class="common-input mb-20 form-control" required="" type="email" autocomplete="off">
                                ...
                                <div class="col-lg-12">
                                    <button class="genric-btn primary" style="float: right;">Edit User</button>
                                </div>
                            </div>
                        </form>
                                </div>
