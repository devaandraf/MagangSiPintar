                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="bradcam_text text-center">
                            <h3>Data SKA Jawa Timur Jan-Des</h3>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body card-block" >
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="au-card m-b-30" >
                                <div class="au-card-inner"> 
                                    <h3 class="title-2 m-b-40" style="text-align:center">10 BESAR NEGARA TUJUAN EKSPOR TAHUN <?= date('Y')-1 ?></h3>
                        ...
                        <div class="col-lg-12">
                            <div class="au-card m-b-30" >
                                <div class="au-card-inner"> 
                                    <h3 class="title-2 m-b-40" style="text-align:center">10 BESAR KOMODITI EKSPOR TAHUN <?= date('Y')-1 ?></h3>
                        ...
                        <div class="col-lg-12">
                            <div class="au-card m-b-30" >
                                <div class="au-card-inner"> 
                                    <h3 class="title-2 m-b-40" style="text-align:center">10 BESAR FORM SKA TAHUN <?= date('Y')-1 ?></h3>
                        ...
                        <div class="col-lg-12">
                            <div class="au-card m-b-30" >
                                <div class="au-card-inner"> 
                                    <h3 class="title-2 m-b-40" style="text-align:center">10 BESAR JUMLAH FORM TAHUN <?= date('Y')-1 ?></h3>
