          ...
          $.ajax({
            ...
            success:function(response){
              ...
              for(var i=0;i<posts.length/2;i++){
                ...
                posts_html += '<div class="col-lg-4 col-md-6"><div class="single_study text-center white_single_study"><div class="thumb"><a href="http://instagram.com/p/'+link+'"><img src="'+url+'" alt=""></a></div><div class="subheading white_subheading"><h4>'
