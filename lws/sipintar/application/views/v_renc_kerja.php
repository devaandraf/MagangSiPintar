        ...
        <div class="service_area minus_padding">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <form class="form-area contact-form text-right" action="<?= base_url() ?>index.php/E_renc_kerja/inputData" method="post" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-lg-4 form-group">
                                    <input name="renc_kerja" placeholder="RENCANA AGENDA" autocomplete="off"  class="common-input mb-20 form-control" required="" type="text">
                                </div>
                                <div class="col-lg-4 form-group">
                                    <input name="realisasi_kerja" placeholder="REALISASI AGENDA "   autocomplete="off"  class="common-input mb-20 form-control" type="text">
                                </div>
                                <div class="col-lg-4 form-group">
                                    <input name="tglagenda_kerja" id="txtTahun1" placeholder="TANGGAL AGENDA"   autocomplete="off"  class="common-input mb-20 form-control" required="" type="text">
                                </div>
                                <div class="col-lg-4 form-group">
                                    <input name="tglmulai_kerja" id="txtTahun2" placeholder="TANGGAL MULAI"   autocomplete="off"  class="common-input mb-20 form-control" required="" type="text">
                                </div>
                                <div class="col-lg-4 form-group">
                                    <input name="tglakhir_kerja" id="txtTahun3" placeholder="TANGGAL BERAKHIR"   autocomplete="off"  class="common-input mb-20 form-control" required="" type="text">
                                </div>
                                <div class="col-lg-4 form-group">
                                    <input name="hsil_kerja" placeholder="HASIL AGENDA"   autocomplete="off"  class="common-input mb-20 form-control" type="text">
                                </div>
                                <div class="col-lg-8 form-group">
                                    <input name="ket_kerja" placeholder="KETERANGAN"   autocomplete="off"  class="common-input mb-20 form-control" type="text">
                                </div>
