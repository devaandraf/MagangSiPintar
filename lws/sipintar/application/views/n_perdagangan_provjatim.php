                ...
                <div class="card-body card-block" >
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="au-card m-b-30" >
                                <div class="au-card-inner">
                                    <h3 class="title-2 m-b-40" style="text-align:center">NERACA DAGANG <br> <b>PROVINSI JATIM</b> <br> TAHUN <?= date('Y') ?></h3>
                                    <div id="chartdiv"></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12">
                            <div class="au-card m-b-30" >
                                <div class="au-card-inner"> 
                                    <h3 class="title-2 m-b-40" style="text-align:center">10 NEGARA TUJUAN EKSPOR TAHUN <?= date('Y') ?></h3>
                        ...
                        <div class="col-lg-12">
                            <div class="au-card m-b-30" >
                                <div class="au-card-inner"> 
                                    <h3 class="title-2 m-b-40" style="text-align:center">10 NEGARA ASAL IMPOR TAHUN <?= date('Y') ?></h3>
                        ...
                        <div class="col-lg-12">
                            <div class="au-card m-b-30" >
                                <div class="au-card-inner"> 
                                    <h3 class="title-2 m-b-40" style="text-align:center">10 KOMODITI EKSPOR TAHUN <?= date('Y') ?></h3>
                        ...
                        <div class="col-lg-12">
                            <div class="au-card m-b-30" >
                                <div class="au-card-inner"> 
                                    <h3 class="title-2 m-b-40" style="text-align:center">10 KOMODITI IMPOR TAHUN <?= date('Y') ?></h3>
