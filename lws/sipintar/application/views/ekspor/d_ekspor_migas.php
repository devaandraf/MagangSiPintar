            ...
            <div class="container">
                <div class="row d-flex align-items-center justify-content-center">
                    <div class="about-content col-lg-12">
                        <h1 class="text-white">
                           Inputan Data Ekspor Migas
                        </h1>
                        <p class="text-white link-nav"><a href="<?= base_url() ?>index.php">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href=""> Agenda</a></p>
                    </div>
                </div>
            </div>
        </section> -->
                   ...
                   <div class="row">
                       <div class="col-xl-12">
                           <div class="bradcam_text text-center">
                               <h3>Inputan Data Ekspor Migas</h3>
        ...
        <div class="service_area minus_padding">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <form class="form-area contact-form text-right" action="<?= base_url() ?>index.php/Data_ekspor_migas/inputSektor" method="post">
                            <div class="row">
                                <div class="col-lg-6 form-group">
                                     <input name="bulan" placeholder="BULAN NON MIGAS" id="txtTahun1" autocomplete="off"  class="common-input mb-20 form-control" required="" type="text">
                                </div>
                                <div class="col-lg-6 form-group">
                                    <input type="hidden" name="migas" value="MIGAS">
                                    <input name="nilai" placeholder="NILAI MIGAS"  step="0.01" autocomplete="off"  class="common-input mb-20 form-control" required="" type="number">
                                </div>
                                <div class="col-lg-12">
                        ...
                        <div class="au-card m-b-30">
                            <div class="au-card-inner">
                                <table id="kinerja" class="table table-hover responsive nowrap" style="width:100%">
                                    <h2 style="text-align:center">DATA EKSPOR MIGAS</h2>
                                    <thead>
                                    ...
                                    <tbody>
                                        <?php $i=1; foreach ($eks_migas as $key => $value){?>
                                        <tr>
                                            <td><?=$i++?></td>
