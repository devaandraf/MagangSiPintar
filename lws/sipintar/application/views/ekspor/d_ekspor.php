                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="bradcam_text text-center">
                                <h3>Inputan Data Ekspor Non Migas</h3>
        ...
        <div class="service_area minus_padding">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <form class="form-area contact-form text-right" action="<?= base_url() ?>index.php/Data_ekspor/inputSektor" method="post">
                            <div class="row">
                                ...
                                <div class="col-lg-6 form-group">
                                    <input name="kategori" value="NONMIGAS" type="hidden">
                        ...
                        <div class="au-card m-b-30">
                            <div class="au-card-inner">
                                <table id="kinerja" class="table table-hover responsive nowrap" style="width:100%">
                                    <h2 style="text-align:center">DATA EKSPOR NON MIGAS</h2>
                                    <thead>
