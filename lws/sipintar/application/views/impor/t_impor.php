                    ...
                    <div class="au-card m-b-30" >
                        <div class="au-card-inner">
                            <table id="kinerja" class="table table-hover responsive nowrap" style="width:100%;background-color: white">
                                <h2 style="text-align:center">KINERJA IMPOR JAWA TIMUR JAN-DES <?= date('Y') ?></h2>
...
<!--                                    <div class="col-lg-4 form-group">
                                ...
                                <thead>
                                      <tr style="background: #c3c3c3;">
                                        ...
                                        <th><?= date('F Y', strtotime('-2 month'));?></th>
                                        <th><?= date('F Y', strtotime('-1 month'));?></th>
                                        <th><?= date('M', strtotime('-2 month')).' - '.date('M', strtotime('-1 month')).' '.date('Y', strtotime('-1 years')) ;?></th>
                                        <th><?= date('M', strtotime('-2 month')).' - '.date('M', strtotime('-1 month')).' '.date('Y') ;?></th>
                                        <th><?= date('M', strtotime('-2 month')).' - '.date('M', strtotime('-1 month')).'<br>(M to M)'?></th>
                                        <th><?= date('Y', strtotime('-1 years')).' - '. date('Y').'<br>(Y to Y)'?></th>
                                        <th><?= 'share<br>'.date('F Y', strtotime('-1 month'));?></th>
                                        <th><?= 'share<br>'.date('M', strtotime('-2 month')).' - '.date('M', strtotime('-1 month')).' '.date('Y') ;?></th>
                                     </tr>
                                </thead>
                                <tbody>
                                     <?php 
