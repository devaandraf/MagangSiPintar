    ...
    <body>
        ...
        <div class="service_area minus_padding">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <form class="form-area contact-form text-right" action="<?= base_url() ?>index.php/I_agenda/updateAgenda" method="post" enctype="multipart/form-data" name="myForm">
                            <div class="row">
                    ...
                    <div class="col-lg-12">
                        <form action="<?= base_url() ?>index.php/I_agenda/agendaUmkm" method="POST" >
