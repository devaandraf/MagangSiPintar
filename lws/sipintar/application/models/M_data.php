...
class M_data extends CI_Model {
    ...
    public function getSektor($dbefore1,$dbefore2,$datenow,$datebefore,$md){
      $sql =  " 
                ...
                where kategori='NONMIGAS' and ekspor_impor='EKSPOR' and  bulan_tahun like '$dbefore2%' GROUP BY sektor
                ) A
                LEFT JOIN(
                SELECT sum(nilai) as nilainon, sektor FROM bps_exim_nonmigas_migas 
                where kategori='NONMIGAS' and ekspor_impor='EKSPOR' and   bulan_tahun like '$dbefore1%' GROUP BY sektor
        ...
        $sql = "
                ...
                (SELECT sum(nilai) as migas  ,kategori 
                    FROM bps_exim_nonmigas_migas  
                        WHERE bulan_tahun like '$dbefore2%' AND kategori='MIGAS' and ekspor_impor='EKSPOR') A

                INNER JOIN 
                (SELECT sum(nilai) as migas  ,kategori 
                    FROM bps_exim_nonmigas_migas  
                        WHERE bulan_tahun like '$dbefore1%' AND kategori='MIGAS' and ekspor_impor='EKSPOR') B 
                ...
                (SELECT sum(nilai) as nonmigas  ,kategori
                    FROM bps_exim_nonmigas_migas  
                        WHERE bulan_tahun like '$dbefore2%' AND kategori='NONMIGAS' and ekspor_impor='EKSPOR') A

                INNER JOIN 
                (SELECT sum(nilai) as nonmigas  ,kategori
                    FROM bps_exim_nonmigas_migas  
                        WHERE bulan_tahun like '$dbefore1%' AND kategori='NONMIGAS' and ekspor_impor='EKSPOR') B 
...
//        die();
    ...
    public function getSektorI($dbefore1,$dbefore2,$datenow,$datebefore,$md){
      $sql =  " 
                ...
                FROM(
                SELECT sum(nilai) as nilainon, sektor FROM bps_exim_nonmigas_migas 
                where kategori='NONMIGAS' and ekspor_impor='IMPOR' and  bulan_tahun like '$dbefore2%' GROUP BY sektor
                ) A
                LEFT JOIN(
                SELECT sum(nilai) as nilainon, sektor FROM bps_exim_nonmigas_migas 
                where kategori='NONMIGAS' and ekspor_impor='IMPOR' and   bulan_tahun like '$dbefore1%' GROUP BY sektor
                ) B on A.sektor = B.sektor
                LEFT JOIN(
                SELECT sum(nilai) as nilainon, sektor FROM bps_exim_nonmigas_migas 
...
//           die();
  ...
  public function getKinerjaI($dbefore1,$dbefore2,$datenow,$datebefore,$md){
        ...
        $sql = "
                ...
                (SELECT sum(nilai) as migas  ,kategori 
                    FROM bps_exim_nonmigas_migas  
                        WHERE bulan_tahun like '$dbefore2%' AND kategori='MIGAS' and ekspor_impor='IMPOR') A

                INNER JOIN 
                (SELECT sum(nilai) as migas  ,kategori 
                    FROM bps_exim_nonmigas_migas  
                        WHERE bulan_tahun like '$dbefore1%' AND kategori='MIGAS' and ekspor_impor='IMPOR') B 
                ...
                (SELECT sum(nilai) as nonmigas  ,kategori
                    FROM bps_exim_nonmigas_migas  
                        WHERE bulan_tahun like '$dbefore2%' AND kategori='NONMIGAS' and ekspor_impor='IMPOR') A

                INNER JOIN 
                (SELECT sum(nilai) as nonmigas  ,kategori
                    FROM bps_exim_nonmigas_migas  
                        WHERE bulan_tahun like '$dbefore1%' AND kategori='NONMIGAS' and ekspor_impor='IMPOR') B 
...
//        die();
    ...
    public function getNeraca(){
        $sql = " SELECT A.nilaiI,A.tahun,B.nilaiE FROM(
                    SELECT sum(nilai) as nilaiI, tahun from data_pusdatin where kd_ekspor_impor='IMPOR'
                    ) A 
                    LEFT JOIN (SELECT sum(nilai) as nilaiE, tahun from data_pusdatin where kd_ekspor_impor='EKSPOR'
    ...
    public function getNeracaNegara($negara){
        $sql = " SELECT A.nilaiI,substr(A.tahun,1 ,4) as tahun,B.nilaiE,sum(B.nilaiE)- sum(A.nilaiI) as sur FROM(
                    SELECT sum(nilai) as nilaiI, substr(tahun,1 ,4) as tahun from data_pusdatin where kd_ekspor_impor='IMPOR' and negara='$negara'  group by substr(tahun,1 ,4) ORDER BY tahun desc
                    ) A 
                    LEFT JOIN (SELECT sum(nilai) as nilaiE, substr(tahun,1 ,4) as tahun from data_pusdatin where kd_ekspor_impor='EKSPOR' and negara='$negara' group by substr(tahun,1 ,4) ORDER BY tahun desc
                    ) B on A.tahun = B.tahun 
...
//        die();
    ...
    public function getHubKomoEkspor($negara){
        $sql = "SELECT b.KD_HS2DIGIT as hs,b.URAIAN as uraian,format(sum(a.nilai),2) as nilai,a.berat from data_pusdatin  a 
    ...
    public function getTahunPusdatin(){
     ...
     public function getNerEkspor($negara,$datenow){
        $sql = "SELECT 
                ...
                format(sum(A.nilai),2) as nilai, 
                B.nilaiE as nilaiE, 
                format(B.nilaiE /A.nilai*100,2) as share
                FROM( 
                SELECT SUM(nilai) as nilai, tahun FROM data_pusdatin 
                where kd_ekspor_impor='EKSPOR' group by substr(tahun,1,4) ) A 
                INNER JOIN( 
                SELECT sum(nilai) as nilaiE, tahun FROM data_pusdatin 
                where kd_ekspor_impor='EKSPOR' AND  negara='$negara'
...
//        die();
    ...
    public function getNerImpor($negara,$datenow){
        $sql = "SELECT  substr(A.tahun,1,4) as tahun, format(sum(A.nilai),2) as nilai, B.nilaiI as nilaiI,format(B.nilaiI /A.nilai*100,2) as share
                    FROM(
                    SELECT SUM(nilai) as nilai, tahun FROM data_pusdatin where kd_ekspor_impor='IMPOR' group by substr(tahun,1,4) 
                    ) A
                    INNER JOIN(
                    SELECT sum(nilai) as nilaiI, tahun  FROM data_pusdatin where kd_ekspor_impor='IMPOR' AND negara='$negara' group by substr(tahun,1,4) 
...
//        echo $sql;die();
    ...
    public function getNeracaPepi(){
     ...
     public function getNeracaNegaraPepi($negara){
        $sql = " SELECT format(B.nilaiI,2) as nilaiI,A.tahun,format(A.nilaiE,2) as nilaiE,sum(A.nilaiE)- sum(B.nilaiI) as sur FROM(
...
//        die();
    ...
    public function getNerEksporPepi($negara){
        $sql = "
                SELECT  A.tahun, format(A.nilai,2) as nilai, B.nilaiE as nilaiE, format(B.nilaiE /A.nilai*100,2) as share
                FROM(
...
//        die();
    ...
    public function getHubKomoEksporPepi($negara){
        $sql = "SELECT  V.KD_HS2DIGIT AS hs, V.KOMODITAS AS uraian, format(SUM(V.JML_USD),2) AS nilai
    ...
    public function getHubKomoImporPepi($negara){
        $sql = "
                SELECT  V.KD_HS2DIGIT AS hs, V.KOMODITAS AS uraian, format(SUM(V.JML_USD),2) AS nilai
...
//        die();
    ...
    public function getNeracaNegaraBps($negara){
        $sql = " SELECT A.nilaiE, A.tahun, B.nilaiI,sum(A.nilaiE)- sum(B.nilaiI) as sur 
                    ...
                    SELECT sum(nilai) as nilaiE,substr(bulan_tahun,1,4) as tahun
                    FROM bps_negara_tujuan_asal
                    where substr(bulan_tahun,1,4) = '2019' and exim='EKSPOR' AND negara='$negara') A
                    LEFT JOIN(
                    SELECT sum(nilai) as nilaiI,substr(bulan_tahun,1,4) as tahun
                    FROM bps_negara_tujuan_asal
                    where substr(bulan_tahun,1,4) = '2019' and exim='IMPOR' AND negara='$negara' ) B on A.tahun = B.tahun
...
//        die();
   ...
   public function getNerEksporBps($negara){
        $sql = "SELECT  A.tahun, A.nilai as nilai, B.nilaiE as nilaiE, format(B.nilaiE /A.nilai*100,2) as share
                    FROM(
...
//        die();
    ...
    public function getNerImporBps($negara){
        $sql = "SELECT  A.tahun, A.nilai as nilai, B.nilaiI as nilaiI,format(B.nilaiI /A.nilai*100,2) as share
                    FROM(
...
//       die();
    ...
    public function getNegaraETotal($dbefore1,$dbefore2,$datenow,$datebefore,$md){
        $sql = "
                ...
                SELECT sum(nilai) as nilai ,negara FROM bps_negara_tujuan_asal WHERE EXIM='EKSPOR' AND bulan_tahun like '$dbefore2%' ) A 
                INNER JOIN ( 
                SELECT sum(nilai) as nilai ,negara FROM bps_negara_tujuan_asal WHERE EXIM='EKSPOR' AND bulan_tahun like '$dbefore1%' ) B 
...
//       die();
    ...
    public function getNegaraITotal($dbefore1,$dbefore2,$datenow,$datebefore,$md){
        $sql = "
                SELECT A.negara, A.nilai as nilai1, B.nilai as nilai2 , C.nilai as nilai3 , D.nilai as nilai4 FROM( 
                SELECT sum(nilai) as nilai ,negara FROM bps_negara_tujuan_asal WHERE EXIM='IMPOR' AND bulan_tahun like '$dbefore2%' ) A 
                INNER JOIN ( 
                SELECT sum(nilai) as nilai ,negara FROM bps_negara_tujuan_asal WHERE EXIM='IMPOR' AND bulan_tahun like '$dbefore1%' ) B 
...
//       die();
    ...
    public function getKomoditi($dbefore1,$dbefore2,$datenow,$datebefore,$md){
        ...
        $sql = "SELECT A.kode_hs,A.uraian_hs, A.nilai as nilai1 , B.nilai as nilai2 , C.nilai as nilai3 , D.nilai as nilai4
                FROM( 
                SELECT sum(nilai) as nilai ,kode_hs, uraian_hs FROM bps_10komoditi where bulan_tahun like '$dbefore2%' and ekspor_impor = 'EKSPOR' group by kode_hs order by id) A 
                INNER JOIN (
                SELECT sum(nilai) as nilai ,kode_hs, uraian_hs FROM bps_10komoditi where bulan_tahun like '$dbefore1%' and ekspor_impor = 'EKSPOR' group by kode_hs order by id) B 
...
//       die();
    ...
    public function getKomoditiTotalLain($dbefore1,$dbefore2,$datenow,$datebefore,$md) {
         $sql = "
                ...
                FROM( 
                SELECT sum(nilai) as nilai ,kode_hs, uraian_hs FROM bps_10komoditi where bulan_tahun like '$dbefore2%' and ekspor_impor = 'EKSPOR' ) A 
                INNER JOIN ( 
                SELECT sum(nilai) as nilai ,kode_hs, uraian_hs FROM bps_10komoditi where bulan_tahun like '$dbefore1%' and ekspor_impor = 'EKSPOR' ) B ON A.kode_hs = B.kode_hs 
                INNER JOIN ( 
                SELECT sum(nilai) as nilai ,kode_hs, uraian_hs FROM bps_10komoditi where bulan_tahun between '$datebefore-01-01' and '$datebefore-$md' and ekspor_impor = 'EKSPOR' ) C ON B.kode_hs = C.kode_hs 
                INNER JOIN ( 
                SELECT sum(nilai) as nilai ,kode_hs, uraian_hs FROM bps_10komoditi where bulan_tahun between '$datenow-01-01' and '$datenow-$md' and ekspor_impor = 'EKSPOR' ) D ON C.kode_hs = D.kode_hs ";
        $result = $this->db->query($sql);
        return $result->row();
    }
    ...
    public function getKomoditiI($dbefore1,$dbefore2,$datenow,$datebefore,$md){
        $sql = "SELECT A.kode_hs,A.uraian_hs, A.nilai as nilai1 , B.nilai as nilai2 , C.nilai as nilai3 ,  D.nilai as nilai4
                FROM( 
                SELECT sum(nilai) as nilai ,kode_hs, uraian_hs FROM bps_10komoditi where bulan_tahun like '$dbefore2%' and ekspor_impor = 'IMPOR' group by kode_hs order by id) A 
                INNER JOIN (
                SELECT sum(nilai) as nilai ,kode_hs, uraian_hs FROM bps_10komoditi where bulan_tahun like '$dbefore1%' and ekspor_impor = 'IMPOR' group by kode_hs order by id) B 
                ON A.kode_hs = B.kode_hs
                INNER JOIN (
    ...
    public function getKomoditiITotalLain($dbefore1,$dbefore2,$datenow,$datebefore,$md) {
         $sql = "
                SELECT A.nilai as nilai1 , B.nilai as nilai2 , C.nilai as nilai3 , D.nilai as nilai4 
                FROM( 
                SELECT sum(nilai) as nilai ,kode_hs, uraian_hs FROM bps_10komoditi where bulan_tahun like '$dbefore2%' and ekspor_impor = 'IMPOR' ) A 
                INNER JOIN ( 
                SELECT sum(nilai) as nilai ,kode_hs, uraian_hs FROM bps_10komoditi where bulan_tahun like '$dbefore1%' and ekspor_impor = 'IMPOR' ) B ON A.kode_hs = B.kode_hs 
                INNER JOIN ( 
                SELECT sum(nilai) as nilai ,kode_hs, uraian_hs FROM bps_10komoditi where bulan_tahun between '$datebefore-01-01' and '$datebefore-$md' and ekspor_impor = 'IMPOR' ) C ON B.kode_hs = C.kode_hs 
                INNER JOIN ( 
                SELECT sum(nilai) as nilai ,kode_hs, uraian_hs FROM bps_10komoditi where bulan_tahun between '$datenow-01-01' and '$datenow-$md' and ekspor_impor = 'IMPOR' ) D ON C.kode_hs = D.kode_hs ";
        $result = $this->db->query($sql);
        return $result->row();
    }
