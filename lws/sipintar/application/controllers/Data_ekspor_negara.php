...
class Data_ekspor_negara extends CI_Controller {
    
    private $filename = "dataexpornegara";
...
//        $data['status'] = $this->data_m->get_status();
        $this->load->view('ekspor/d_ekspor_negara');       
    }
    ...
    public function upload_excel(){
        ...
        for($row = 1; $row <= $highestRow; $row++){
            ...
            $data = array(
                    'no'                =>$rowData[0][0], // Insert data nis dari kolom A di excel
...
//                    'berat'         =>$rowData[0][10],
              ...
              $this->m_data->uploadExcelNegara($data);
           
        }
            
        redirect("Data_ekspor_negara"); // Redirect ke halaman awal (ke controller siswa fungsi index)
    }
