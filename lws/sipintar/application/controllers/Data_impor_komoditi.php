...
class Data_impor_komoditi extends CI_Controller {
    ...
    private $filename = "dataimporkomoditi";
...
//                    'berat'         =>$rowData[0][10],
           ...
           $this->m_data->uploadExcelKomoditasI($data);
           
        }
            
        redirect("Data_impor_komoditi"); // Redirect ke halaman awal (ke controller siswa fungsi index)
    }
