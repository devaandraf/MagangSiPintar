...
class Data_ekspor_komoditi_input extends CI_Controller {
...
//        }
	...
	{  
		...
		$this->load->view('ekspor/d_ekspor_komoditi',$data);
	}
        ...
        public function inputKomoditiEkspor(){
            ...
            $this->form_validation->set_rules('hs2', 'hs2', 'required');
                if ($this->form_validation->run() === TRUE) {
                    ...
                    $this->m_input->insertKomoditiEkspor($insert);
                    redirect('Data_ekspor_komoditi');
                }
            else {
