...
class Data_impor_negara extends CI_Controller {
    ...
    private $filename = "dataimpornegara";
...
//                    'berat'         =>$rowData[0][10],
           ...
           $this->m_data->uploadExcelNegaraI($data);
           
        }
            
        redirect("Data_impor_negara"); // Redirect ke halaman awal (ke controller siswa fungsi index)
    }
