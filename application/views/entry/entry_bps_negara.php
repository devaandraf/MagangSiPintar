            ...
            <div class="container">
                <div class="row">
                   ...
                   <div class="col-lg-4" style="border: 3px solid;border-color: #dedede;margin-right:10px">
                        <form class="form-area contact-form text-right" action="<?= base_url() ?>index.php/E_bps_negara/upload_excel" method="post" enctype="multipart/form-data">
                            <div class="row">
<!--                                <div class="col-lg-3 form-group">
                                    ...
                                    <div class="col-lg-12 form-group">
                                        <h3 style="text-align: left;color:green">
                                            <a href="<?= base_url()?>format_upload/bpsnegaratujuanatauasal.xlsx" target="_blank" download> 
                    ...
                    <div class="col-lg-7" style="border: 3px solid;border-color: #dedede;"> 
                          <form class="form-area contact-form text-right" action="<?= base_url() ?>index.php/E_bps_negara/inputData" method="post" enctype="mE_umkmultipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-8 form-group">
                                    <select class="common-input mb-20 form-control select2" name="negara" >
