...
<html lang="zxx" class="no-js">
    ...
    <body>
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="bradcam_text text-center">
                            <h3>UPLOAD DATA BPS MIGAS & NON MIGAS</h3>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4" style="border: 3px solid;border-color: #dedede;margin-right:10px">
                        <form class="form-area contact-form text-right" action="<?= base_url() ?>index.php/E_bps_migas_nonmigas/upload_excel" method="post" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-lg-12 form-group">
                                    <h3 style="text-align: center;color:#001d38">
                                        <a href="<?= base_url() ?>format_upload/BPSeximmigasnonmigas.xlsx" target="_blank" download> 
                                            <i class="fa fa-download"> Format Upload Excel</i>
                                        </a>
                                    </h3>
                                </div>
                                <div class="col-lg-12 form-group">
                                    <input type="file" name="file" id="file" accept=".xlsx" required=""  class="common-input mb-20 form-control" >
                                </div>
                                <div class="col-lg-12 form-group">
                      ...
                      <div class="col-lg-7" style="border: 3px solid;border-color: #dedede;"> 
                          <form class="form-area contact-form text-right" action="<?= base_url() ?>index.php/E_bps_migas_nonmigas/inputData" method="post" enctype="mE_umkmultipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 form-group">
                                    <select class="common-input mb-20 form-control select2" name="sektor" >
                                        <option value="" selected>Sektor</option>
        ...
        <script>
            function myFunction() {
                if("#file"==null){
                alert("Upload data anda, dengan format yang sesuai !")}else{};
             }else{
                  alert("Data anda telah ditambahkan, Terimakasih !!! :)")}else{};
             }
