        ...
        <div class="service_area minus_padding">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6" style="border:3px solid;border-color: #dedede;">
                        <div class="box" style="margin:5px">
                            <form  action="<?= base_url() ?>index.php/forecast/filter" method="post">
                            <div class="row">
                            <div class="col-md-12">
                            ...
                            <div class="col-md-6">
                                    <input name="firstbultah" id="txtTahun1" placeholder="BULAN TAHUN"   autocomplete="off"  class="common-input mb-20 form-control" required="" type="text">
                       </div> <div class="col-md-6">
                                    <input name="lastbultah" id="txtTahun2" placeholder="BULAN TAHUN"   autocomplete="off"  class="common-input mb-20 form-control" required="" type="text">
                       </div>
                            </div>
                        ...
                        <div class="au-card m-b-30">
                            <div class="au-card-inner">
                                <table id="kinerja" class="table table-hover responsive nowrap" style="width:100%">
                                    <h2 style="text-align:center">FORECAST PUSDATIN EKSPOR</h2>
                        ...
                        <div class="au-card m-b-30">
                            <div class="au-card-inner">
                                <table id="kinerja2" class="table table-hover responsive nowrap" style="width:100%">
                                    <h2 style="text-align:center">FORECAST PUSDATIN IMPOR</h2>
