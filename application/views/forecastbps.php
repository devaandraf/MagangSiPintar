                ...
                <div class="row">
                    ...
                    <div class="col-md-6" style="border:3px solid;border-color: #dedede;">
                        <div class="box" style="margin:5px">
                            <form  action="<?= base_url() ?>index.php/forecastbps/filter" method="post">
                            <div class="row">
                            <div class="col-md-12">
                        ...
                        <div class="au-card m-b-30">
                            <div class="au-card-inner">
                                <table id="kinerja" class="table table-hover responsive nowrap" style="width:100%">
                                    <h2 style="text-align:center">FORECAST BPS EKSPOR</h2>
