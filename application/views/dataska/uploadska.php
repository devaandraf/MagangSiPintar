        ...
        <div class="service_area minus_padding">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <form class="form-area contact-form text-right" action="<?= base_url() ?>index.php/upload/Dataska/upload_excel" method="post" enctype="multipart/form-data">
                            <div class="row">
...
<div class="col-lg-12 form-group">
                                        <h3 style="text-align: left;color:green">
                                            <a href="<?= base_url()?>format_upload/format-upload-ska.xlsx" target="_blank" download> 
