...
<!--                <div class="col-lg-12">
                ...
                <div class="col-lg-12">
                    <div class="au-card m-b-30" >
                        <div class="au-card-inner">
                            <table id="kinerja" class="table table-hover responsive nowrap" style="width:100%;background-color: white">
                                <h2 style="text-align:center">KINERJA EKSPOR JAWA TIMUR <?= date('Y') ?></h2>
                                    <p style="text-align:center;" >Data berdasarkan BPS</p>
                                <thead>
                                    <tr style="background: #c3c3c3;">
                                        <th>No</th>
                                ...
                                <tbody>
                                    ...
                                    foreach ($kinerja as $key => $value) {
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align:right"><?= ($value->nilai3) ? round(($value->nilai4 - $value->nilai3) / $value->nilai3 * 100, 2) : 0 ?></td>
                                          <?php if($value->nilai4==0) {?>
                                            <td style="text-align:right">-</td>
                                            <?php }else { ?>
                                            <td style="text-align:right"><?= round($value->nilai4 / $total4 * 100, 2) ?></td>
                                            <?php }?>
                                        </tr>
                                    <?php } ?>
                                    <tr>
                                        ...
                                        <td style="text-align:right"><?= ($total3) ? round(($total4 - $total3) / $total3 * 100, 2) : 0 ?></td>
