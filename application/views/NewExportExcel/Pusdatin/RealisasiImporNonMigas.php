<?php 
        ...
        header("Content-Disposition: attachment; filename=Realisasi Impor Non Migas Jawa Timur - {$datanegara}.xls");
    ?>
    <div class="container">
        <div class="row py-5">
            <div class="col-lg-12">
                <div class="au-card m-b-30">
                    <div class="au-card-inner">
                        <table id="impor" class="table table-hover responsive nowrap" style="width:100%">
                            <h2 style="text-align:center">Realisasi Impor Non Migas Jawa Timur - <?=  $datanegara ?><label id="lblBlNegara4"  style="color: red;font-size: 36px;text-transform: uppercase;"></label> </h2>
