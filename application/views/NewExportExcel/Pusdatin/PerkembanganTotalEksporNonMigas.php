    ...
    <?php 
        ...
        header("Content-Disposition: attachment; filename=Perkembangan Total Ekspor Non Migas Jawa Timur - {$datanegara}.xls");
    ?>
<div class="container">
    <div class="row py-5">
        <div class="col-lg-12">
                    ...
                    <table id="ekspor" class="table table-hover responsive nowrap" style="width:100%">
                        ...
                        <thead>
                            <tr style="text-align-last: center">
                                ...
                                <th>EKS KE <label id="lblBlNegara3" style="color: red;font-size: 15px;text-transform: uppercase;"><?= $datanegara ?></label> </th>
                                <th>PERTUMB(%)</th>
                                <th>SHARE(%)</th>
                            </tr>
                        </thead>
