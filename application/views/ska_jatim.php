                ...
                <div class="card-body card-block" >
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="au-card m-b-30" >
                                <div class="au-card-inner"> 
                                    <h3 class="title-2 m-b-40" style="text-align:center">Nilai Ekspor dari Form DAB Tahun <?= date('Y') ?></h3>
                                    <div id="BarFormDAB"></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12">
                            <div class="au-card m-b-30" >
                                <div class="au-card-inner"> 
                                    <h3 class="title-2 m-b-40" style="text-align:center">JUMLAH FORM DAB TAHUN <?= date('Y') ?></h3>
                                    <div id="BarchartdivDAB"></div>
                                </div>
                            </div>
                        </div>
                    </div>
  ...
  categoryAxis.renderer.labels.template.adapter.add("dy", function(dy, target) {
            ...
            <script>
                am4core.ready(function () {
                    ...
                    // Create chart instance
                    var chart = am4core.create("BarFormDAB", am4charts.XYChart3D);

                    // Add data
                    chart.data = <?php echo json_encode($barFormDAB) ?>
             ...
             <script>
                am4core.ready(function () {
                    ...
                    // Create chart instance
                    var chart = am4core.create("BarchartdivDAB", am4charts.XYChart3D);

                    // Add data
                    chart.data = <?php echo json_encode($barJumlahFormDAB) ?>
