                        ...
                        <div class="au-card m-b-30">
                            <div class="au-card-inner">
                                <table id="kinerja" class="table table-hover responsive nowrap" style="width:100%">
                                    ...
                                    <div class="text-left">
                                        <a id="NeracaPerdagangan" href="<?= base_url() ?>index.php/exportExcel/ExportBPS/NeracaPerdagangan/default" class="btn btn-success btn-sm">
                                            Excel
                                        </a>
                                    </div>
                                    <thead>
                        ...
                        <div class="au-card m-b-30">
                            <div class="au-card-inner">
                                <table id="ekspor" class="table table-hover responsive nowrap" style="width:100%">
                                    ...
                                    <p>Data berdasarkan pusdatin</p>
                                    <div class="text-left">
                                        <a id="PerkembanganTotalEksporNonMigas" href="<?= base_url() ?>index.php/exportExcel/ExportBPS/PerkembanganTotalEksporNonMigas/default" class="btn btn-success btn-sm">
                                            Excel
                                        </a>
                                    </div>
                                    <thead>
                        ...
                        <div class="au-card m-b-30">
                            <div class="au-card-inner">
                                <table id="impor" class="table table-hover responsive nowrap" style="width:100%">
                                    ...
                                    <p>Data berdasarkan pusdatin</p>
                                    <div class="text-left">
                                        <a id="PerkembanganImporNonMigas" href="<?= base_url() ?>index.php/exportExcel/ExportBPS/PerkembanganImporNonMigas/default" class="btn btn-success btn-sm">
                                            Excel
                                        </a>
                                    </div>
                                    <thead>
                    ...
                    <div class="au-card m-b-30">
                        <div class="au-card-inner">
                            <table id="analisa" class="table table-hover responsive" style="width:100%">
                                <h2 style="text-align:center">HASIL FORM ANALISA</h2>
                                <thead>
...
<?php } elseif ($this->session->userdata['user_role'] == "ADMIN") { ?>
                <div class="container">
                    ...
                    <div class="row py-5">
                        <div class="col-lg-12">
                            <form  action="<?= base_url() ?>index.php/show/Hub_dagang_bps/analisa" method="post">
                                <div class="row">	
                                    ...
                                    <div class="col-lg-3 form-group">
                                        <input name="date" type="date" class="common-input form-control" value="" placeholder="" required="">
                                    </div>
                                    <div class="col-lg-9 form-group">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <button class="genric-btn primary" style="float: right;" type="submit">Simpan Analisa</button>											
                                    </div>
                                </div>
                            </form>	
                        </div>
                                ...
                                <tbody>
                                    ...
                                    foreach ($analisa as $key => $value) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?= $value->subject ?></td>
                                            <td><?= $value->data ?></td>
                                            <td style="width: 70%"><?= $value->deskripsi ?></td>
...
<?php } ?>
        ...
        <div class="modal fade" id="deletemodal" tabindex="-1" role="dialog" aria-labelledby="printmodalLabel" aria-hidden="true">
            <form method="POST" action="<?= base_url() ?>index.php/show/Hub_dagang_bps/del_analisa">
        ...
        <div class="modal fade" id="editmodal" tabindex="-1" role="dialog" aria-labelledby="editmodalLabel" aria-hidden="true">
            <form method="POST" action="<?= base_url() ?>index.php/show/Hub_dagang_bps/editAnalisa" enctype="multipart/form-data">
        ...
        <script type="text/javascript">
                                        ...
                                        $(function () {
                                            $('#btnTampilkan').click(function () {
                                                ...
                                                document.getElementById("NeracaPerdagangan").setAttribute("href", "<?= base_url() ?>index.php/exportExcel/ExportBPS/NeracaPerdagangan/"+negara); 
                                                document.getElementById("PerkembanganTotalEksporNonMigas").setAttribute("href", "<?= base_url() ?>index.php/exportExcel/ExportBPS/PerkembanganTotalEksporNonMigas/"+negara); 
                                                document.getElementById("PerkembanganImporNonMigas").setAttribute("href", "<?= base_url() ?>index.php/exportExcel/ExportBPS/PerkembanganTotalEksporNonMigas/"+negara); 
                                                ...
                                                $.ajax({
                                                    type: "POST",
                                                    url: "<?php echo base_url(); ?>index.php/show/Hub_dagang_bps/getSearchNegaraBps",
                                                    data: {
                                                        "negara": negara
                                                    },
                                                    dataType: "html",
...
//
            ...
            $('#editmodal').on('shown.bs.modal', function (e) {
             ...
             $('#editmodal').on('shown.bs.modal', function (e) {
                        var id = $(e.relatedTarget).data('id');
                        $.ajax({
                            url: '<?= base_url() ?>index.php/show/Hub_dagang_bps/ajax_get_data/' + id,
                            dataType: 'json',
