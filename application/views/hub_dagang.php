                        ...
                        <div class="au-card m-b-30">
                            <div class="au-card-inner">
                                <table id="kinerja" class="table table-hover responsive nowrap" style="width:100%">
                                    ...
                                    <div class="text-left">
                                        <a id="NeracaPerdagangan" href="<?= base_url() ?>index.php/exportExcel/ExportPusdatin/NeracaPerdagangan/default" class="btn btn-success btn-sm">
                                            Excel
                                        </a>
                                    </div>
                                    <thead>
                        ...
                        <div class="au-card m-b-30">
                            <div class="au-card-inner">
                                <table id="ekspor" class="table table-hover responsive nowrap" style="width:100%">
                                    ...
                                    <p>Data berdasarkan pusdatin</p>
                                    <div class="text-left">
                                        <a id="PerkembanganTotalEksporNonMigas" href="<?= base_url() ?>index.php/exportExcel/ExportPusdatin/PerkembanganTotalEksporNonMigas/default" class="btn btn-success btn-sm">
                                            Excel
                                        </a>
                                    </div>
                                    <thead>
                        ...
                        <div class="au-card m-b-30">
                            <div class="au-card-inner">
                                <table id="impor" class="table table-hover responsive nowrap" style="width:100%">
                                    ...
                                    <p>Data berdasarkan pusdatin</p>
                                    <div class="text-left">
                                        <a id="RealisasiImporNonMigas" href="<?= base_url() ?>index.php/exportExcel/ExportPusdatin/RealisasiImporNonMigas/default" class="btn btn-success btn-sm">
                                            Excel
                                        </a>
                                    </div>
                                    <thead>
                        ...
                        <div class="au-card m-b-30">
                            <div class="au-card-inner">
                                <table id="komoeks" class="table table-hover responsive nowrap" style="width:100%">
                                    ...
                                    <p>Data berdasarkan pusdatin</p>
                                    <div class="text-left">
                                        <a id="KomoditiEkspor" href="<?= base_url() ?>index.php/exportExcel/ExportPusdatin/KomoditiEkspor/default" class="btn btn-success btn-sm">
                                            Excel
                                        </a>
                                    </div>
                                    <thead>
                        ...
                        <div class="au-card m-b-30">
                            <div class="au-card-inner">
                                <table id="komoimp" class="table table-hover responsive nowrap" style="width:100%">
                                    ...
                                    <p>Data berdasarkan pusdatin</p>
                                    <div class="text-left">
                                        <a id="KomoditiImpor" href="<?= base_url() ?>index.php/exportExcel/ExportPusdatin/KomoditiImpor/default" class="btn btn-success btn-sm">
                                            Excel
                                        </a>
                                    </div>
                                    <thead>
        ...
        <script type="text/javascript">
                                        ...
                                        $(function () {
                                            $('#btnTampilkan').click(function () {
                                                ...
                                                document.getElementById("PerkembanganTotalEksporNonMigas").setAttribute("href", "<?= base_url() ?>index.php/exportExcel/ExportPusdatin/PerkembanganTotalEksporNonMigas/"+negara); 
                                                document.getElementById("NeracaPerdagangan").setAttribute("href", "<?= base_url() ?>index.php/exportExcel/ExportPusdatin/NeracaPerdagangan/"+negara); 
                                                document.getElementById("RealisasiImporNonMigas").setAttribute("href", "<?= base_url() ?>index.php/exportExcel/ExportPusdatin/RealisasiImporNonMigas/"+negara); 
                                                document.getElementById("KomoditiEkspor").setAttribute("href", "<?= base_url() ?>index.php/exportExcel/ExportPusdatin/KomoditiEkspor/"+negara); 
                                                document.getElementById("KomoditiImpor").setAttribute("href", "<?= base_url() ?>index.php/exportExcel/ExportPusdatin/KomoditiImpor/"+negara); 
