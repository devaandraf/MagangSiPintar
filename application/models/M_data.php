...
class M_data extends CI_Model {
    ...
    public function getNamaPL() {
     ...
     public function getSektorSearch() {
        $result = $this->db->get('mst_sektor');
        return $result->result();
    }
     public function getNegaraSearch() {
...
//    ============================================END ========================================
             public function getForecastBPS(){
      $sql =  " 
            SELECT sum(nilai) as nilai,substr(bulan_tahun,1,4) as tahun,  substr(bulan_tahun,6,2) as bulan FROM bps_10komoditi 
            WHERE substr(bulan_tahun,1,4)='2019' 
            and ekspor_impor='EKSPOR'
            GROUP BY bulan
                 ORDER BY substr(bulan_tahun,1,7)";
//           print($sql);
//           die();
        $result = $this->db->query($sql);
        return $result->result();
    }
    public function getForecastIBPS(){
      $sql =  " 
            SELECT sum(nilai) as nilai,substr(bulan_tahun,1,4) as tahun,  substr(bulan_tahun,6,2) as bulan FROM bps_10komoditi 
            WHERE substr(bulan_tahun,1,4)='2019' 
    ...
    public function getForecastTHBPS($firstmonth,$datenow){
      $sql =  " 
            SELECT sum(nilai) as nilai,substr(bulan_tahun,1,4) as tahun,  substr(bulan_tahun,6,2) as bulan FROM bps_10komoditi 
            WHERE substr(bulan_tahun,1,7) BETWEEN '$firstmonth' AND '$datenow'
            and ekspor_impor='EKSPOR'
            GROUP BY bulan
                 ORDER BY substr(bulan_tahun,1,7)";
//           print($sql);
//           die();
    ...
    public function getForecastTHsumBPS($firstmonth,$datenow){
      $sql =  " 
            SELECT sum(nilai) as nilai,substr(bulan_tahun,1,4) as tahun,  substr(bulan_tahun,6,2) as bulan FROM bps_10komoditi 
            WHERE substr(bulan_tahun,1,7) BETWEEN '$firstmonth' AND '$datenow'
            and ekspor_impor='EKSPOR'";
...
//           die();
    ...
    public function getForecastITHBPS($firstmonth,$datenow){
      $sql =  " 
            SELECT sum(nilai) as nilai,substr(bulan_tahun,1,4) as tahun,  substr(bulan_tahun,6,2) as bulan FROM bps_10komoditi 
            WHERE substr(bulan_tahun,1,7) BETWEEN '$firstmonth' AND '$datenow'
            and ekspor_impor='IMPOR'
...
//           die();
    ...
    public function getForecastITHsumBPS($firstmonth,$datenow){
      $sql =  " 
            SELECT sum(nilai) as nilai,substr(bulan_tahun,1,4) as tahun,  substr(bulan_tahun,6,2) as bulan FROM bps_10komoditi 
            WHERE substr(bulan_tahun,1,7) BETWEEN '$firstmonth' AND '$datenow'
            and ekspor_impor='IMPOR'";
...
//        die();
    ...
    public function getUmkmAgenda($id_umkm){
        $where = array(
            'agenda_umkm_ln_dn.id_umkm' => $id_umkm,
        );

        $res = $this->db->select('*')
        ->from('agenda_ln_dn')
        ->join('agenda_umkm_ln_dn', 'agenda_ln_dn.id = agenda_umkm_ln_dn.id_agenda')
        ->where($where)->get();
...
//        die();
    ...
    // Master Data
    public function getSKA($date){
        $res = $this->db->select('*')
        ->from('t_ska')
        ->where("tgl_ska BETWEEN '$date-01' AND '$date-31'")->get();
        return $res->result();   
    }
    
    public function getPusdatin($date){
        $res = $this->db->select('*')
        ->from('data_pusdatin')
        ->where("tahun BETWEEN '$date-01' AND '$date-31'")->get();
        return $res->result();   
    }
    
    public function getBPSMigas($date){
        $res = $this->db->select('*')
        ->from('bps_exim_nonmigas_migas')
        ->where("bulan_tahun BETWEEN '$date-01' AND '$date-31'")->get();
        return $res->result();   
    }
    
    public function getBPSNasional($date){
        $res = $this->db->select('*')
        ->from('bps_data_nasional')
        ->where("bulan_tahun BETWEEN '$date-01' AND '$date-31'")->get();
        return $res->result();   
    }
    
    public function getBPSKomoditi($date){
        $res = $this->db->select('*')
        ->from('bps_10komoditi')
        ->where("bulan_tahun BETWEEN '$date-01' AND '$date-31'")->get();
        return $res->result();   
    ...
    public function getBPSNegara($date){
        $res = $this->db->select('*')
        ->from('bps_negara_tujuan_asal')
        ->where("bulan_tahun BETWEEN '$date-01' AND '$date-31'")->get();
        return $res->result();   
    ...
    //NEW
     public function uploadExcel($table,$data) {
    ...
    public function uploadExcelPusdatin($data) {
        $this->db->insert_batch('data_pusdatin', $data);
